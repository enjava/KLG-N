 ...
 * 订单管理之已撤销 fragment.
 */
public class DDGLRevokedFragment extends BaseFragment {
    ...
    public static DDGLRevokedFragment newInstance(String param1) {
        DDGLRevokedFragment fragment = new DDGLRevokedFragment();
