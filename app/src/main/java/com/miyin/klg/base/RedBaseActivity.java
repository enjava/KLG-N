...
/**
 * @Title: RedBaseActivity.java
 * @Description: 基础Activity，用户Activity可以继承此Activity，实现自定义的方法，另外可以实现对话框等其他公用方法
 */
public abstract class RedBaseActivity extends AppCompatActivity {
    ...
    protected void exitBy2click() {
        ...
        if (isExit == false) {
            isExit = true;
            Toast.makeText(RedBaseActivity.this, "再按一次退出程序", Toast.LENGTH_SHORT).show();
            eExit = new Timer();
