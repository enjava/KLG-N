 ...
 * @author
 */
public class RedQRTitleBar extends RelativeLayout implements OnClickListener {
    ...
    public RedQRTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(
                R.layout.view_redqrtitlebar, this, true);
