...
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public MainNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.colorPrimaryDark));
    ...
    public void setDefaultLayout(int layoutID) {
        if (-1 == layoutID) {
            defaultLayout = R.layout.comui_tab_view;
        }
    ...
    protected void onAttachedToWindow() {
        ...
        // throw new
        // RuntimeException("parent activity must is extends FragmentActivity");
        // }
