...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 标题正常时的颜色
     */
    private static final int COLOR_TEXT_NORMAL = Color.parseColor("#A4A2A6");
    /**
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = Color.parseColor("#FE4945");
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(Color.parseColor("#FE4945"));
    ...
    private String TAG = "ViewPageIndicator_log";
    ...
    private void initTriangle() {
        ...
        mPath.moveTo(0, 0);
        mPath.lineTo(getScreenWidth() / (mTabVisibleCount), 0);
        mPath.lineTo(getScreenWidth() / (mTabVisibleCount), -5);
        mPath.lineTo(0, -5);
        mPath.close();
    }
